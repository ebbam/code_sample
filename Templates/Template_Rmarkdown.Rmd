...
#     }
# 
# saveRDS(mods, here("Templates/eu_road_basic_models.RDS"))

mods <- readRDS(here("Templates/eu_road_basic_models.RDS"))
...
```{r, echo = FALSE, fig.height = 14}
# Code for executing models in "Templates/eu_road_nolog_models.RDS"
# cl <- makeCluster(6)
# registerDoParallel(cl)
#
...
# saveRDS(nmods, here("Templates/eu_road_nolog_models.RDS"))
...
tmods <- readRDS(here("Templates/eu_road_nolog_models.RDS")) %>%
